...
import { DollarSign, ShoppingCart, TrendingUp, TrendingDown, Package, AlertTriangle, FileBarChart2, CalendarRange, Wallet, Boxes, Receipt, MinusCircle, Award, CalendarDays, CircleDot, FileDown, FileSpreadsheet } from "lucide-react";
...
import {
  ...
  availableYears,
} from "../../presenters/useDashboardPresenter";
    ...
    <div className="fade-in dashboard-page">
      ...
      <div className="page-body">
        ...
        <div className="stats-grid">
          ...
          />
          <StatCard
            icon={TrendingUp} tone="green" label={`Laba Kotor (${range.label})`}
          ...
          <StatCard
            ...
            change="Dihitung dari stok x harga modal" changeTone="neutral"
          />
          <StatCard
                  ...
                  return products.map((p, idx) => (
                    <div className="dashboard-rank-item" key={`${p.name}-${idx}`}>
                      ...
                      <div className="dashboard-rank-item__body">
                        ...
                        <div className="dashboard-rank-item__subtitle">{p.category} · {p.qty} unit terjual</div>
