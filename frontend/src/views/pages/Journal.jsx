...
import { useJournalPresenter } from "../../presenters/useJournalPresenter";
  ...
  return (
    <div className="card">
      ...
      <div className="form-group">
        ...
        <input type="number" className="form-input" placeholder="Mis. 10000000" value={f.amount} onChange={(e) => j.updateCapitalForm("amount", e.target.value)} />
      </div>
    ...
    <div className="card">
      ...
      {j.manualLines.map((line, idx) => (
        <div key={idx} className="flex gap-2 mb-2 items-center" style={{ flexWrap: "wrap" }}>
          ...
          <input type="number" className="form-input" style={{ width: 110 }} placeholder="Debit" value={line.debit} onChange={(e) => j.updateManualLine(idx, "debit", e.target.value)} />
          <input type="number" className="form-input" style={{ width: 110 }} placeholder="Kredit" value={line.credit} onChange={(e) => j.updateManualLine(idx, "credit", e.target.value)} />
