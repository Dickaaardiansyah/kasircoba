...
import {
  useReceivablesPresenter,
  useReceivableFormPresenter,
  useReceivablePaymentPresenter,
} from "../../presenters/useReceivablesPresenter";
import { PageLoader, EmptyState, SearchInput, Badge, StatCard } from "../components/UI";
...
export default function Piutang() {
  const rp = useReceivablesPresenter();
...
function ReceivableFormModal({ customers, onSuccess, onClose }) {
  const f = useReceivableFormPresenter({ customers, onSuccess, onClose });
  return (
          ...
          <div className="modal-body">
            ...
            <div className="grid-2">
              <div className="form-group">
                ...
                <input type="number" min="0" className="form-input" value={f.form.amount} onChange={(e) => f.setField("amount", e.target.value)} placeholder="0" />
              </div>
              <div className="form-group">
                <label className="form-label">Sudah Dibayar (DP)</label>
                <input type="number" min="0" className="form-input" value={f.form.paid_amount} onChange={(e) => f.setField("paid_amount", e.target.value)} placeholder="0" />
              </div>
            </div>
            <div className="grid-2">
              <div className="form-group">
...
function ReceivablePaymentModal({ receivable, onSuccess, onClose }) {
  const f = useReceivablePaymentPresenter({ receivable, onSuccess, onClose });
  return (
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
        ...
        <form onSubmit={f.submit}>
          <div className="modal-body">
            ...
            <div className="form-group">
              ...
              <input type="number" min="0" max={f.sisa} className="form-input" value={f.form.amount} onChange={(e) => f.setField("amount", e.target.value)} autoFocus />
            </div>
            <div className="grid-2">
              <div className="form-group">
