...
import { useLabaRugiPresenter, EMPTY_EXPENSE_FORM } from "../../presenters/useLabaRugiPresenter";
      ...
      <div className="modal modal--small">
        ...
        <div className="modal-body">
          ...
          <div className="form-group">
            ...
            <input type="number" className="form-input" value={form.amount} onChange={(e) => setField("amount", e.target.value)} />
          </div>
        </div>
