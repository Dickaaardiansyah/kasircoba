...
import {
  usePayablesPresenter,
  usePayableFormPresenter,
  usePayablePaymentPresenter,
} from "../../presenters/usePayablesPresenter";
...
function PayableFormModal({ suppliers, onSuccess, onClose }) {
  const f = usePayableFormPresenter({ suppliers, onSuccess, onClose });
  return (
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        <div className="modal-header">
...
function PayablePaymentModal({ payable, onSuccess, onClose }) {
  const f = usePayablePaymentPresenter({ payable, onSuccess, onClose });
  return (
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
