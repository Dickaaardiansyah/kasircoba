...
const payableService = {
  ...
  async recordPayment(id, payload) {
    ...
    // Posting jurnal otomatis (Dr Utang Usaha, Cr Kas/Bank) — best-effort,
    // sama seperti pola postReceivablePaymentJournal: kegagalan di sini
    // TIDAK membatalkan pembayaran yang sudah tersimpan.
    try {
      ...
      console.error(
        "Gagal posting jurnal pembayaran hutang:",
