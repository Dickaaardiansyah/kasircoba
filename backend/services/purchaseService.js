...
const purchaseService = {
  ...
  async recordPurchase(payload) {
    ...
    // Posting jurnal otomatis (Dr Persediaan, Cr Kas). Best-effort — lihat
    // catatan desain di services/journalService.js.
    try {
      await journalService.postPurchaseJournal(purchase);
    } catch (journalError) {
      console.error("Gagal posting jurnal pembelian:", journalError.message);
    }
